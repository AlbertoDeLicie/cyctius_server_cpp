...
public:
	...
	explicit WebsocketSession(boost::asio::io_context& io, boost::asio::ip::tcp::socket socket, std::shared_ptr<RouterCoro> router);
...
private:
	...
	boost::asio::awaitable<void> async_write(std::string message);
